...
def main():
	...
	print FIRST(test)
	print "Testing End (expect 4): "
	print END(test)
	print "Testing Next pos2 (expect 0): "
	print NEXT(2, test)
	print "Testing previous pos2 (expect 2): "
	print PREVIOUS(2, test)
	print "Testing Locate (expect 0): " 
	print LOCATE(1, test)
	print "Testing Retrieve (expect 9): " 
	print RETRIEVE(2, test)
